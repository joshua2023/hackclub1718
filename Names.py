...
def start():#This program askes each of my family members a trivia question based on what they say their name is
        ...
        if(myName == "Joshua"):#Joshua Question
            print("Hi, Joshua! Hope you are doing well today!")
           ...
           print("Hi, Doug! Hope you are doing well today!")
           question=input("Would you like to hear your question(yes or no)? Type in lowercase")
           if(question == "yes"):
           ...
           print("Hi, Emily! Hope you are doing well today!")
           question=input("Would you like to hear your question(yes or no)? Type in lowercase")
           if(question == "yes"):
           ...
           print("Hi, Grace! Hope you are doing well today!")
           question=input("Would you like to hear your question(yes or no)? Type in lowercase")
           if(question == "yes"):
            ...
            print("Hi, someone whose name I dont recognise! Hope you are doing well today!")
            question=input("Would you like to hear your question(yes or no)? Type in lowercase")
            if(question == "yes"):
